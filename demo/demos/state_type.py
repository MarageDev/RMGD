...
class AppState:
    ...
    batch_tensor_path : str = "./cached_tensors/taesd_encoded_dataset/fully_encoded_celebahq_dataset_split_01.pt"
    pcagmm_model_path: str = "./cached_tensors/pcagmm/tensor_pcagm_512_10.pt" # 512 pca, 10 gmm