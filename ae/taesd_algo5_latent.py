...
if __name__ == "__main__":
    ...
    taesd = TAESD(*["ae/taesd/taesdxl_encoder.pth", "ae/taesd/taesdxl_decoder.pth"]).to(device)
    encoded_tensor = transform_to_latent_space(data_tensor,taesd=taesd, dev=device)
    a5 = algo5(encoded_tensor, patchsize=PATCHSIZE, N=25, device=device, mask_weight_type="",schedule='linear', seed=2)
