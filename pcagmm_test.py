...
def quick_create_model(fitting_data_tensor:tuple[str,torch.TensorType],settings:dict = {"PCA_dim": 256,"GMM_comp": 5, "PCA_ITER":100, "GMM_INIT_ITER":100},search_dir:str="./data/cached_tensors/pcagmm",save_path:str="./data/cached_tensors/pcagmm", force_rewrite:bool=False, seed:int=None,device:str="cuda:0") -> PCAGMMFaceGenerator:
    ...
    if can_load:
        ...
        print("No existing PCAGMM Face Generator, creating one...")
...
if __name__ == "__main__":
    ...
    #encoded_batch_tensor = torch.load("data/cached_tensors/taesd_encoded_dataset/fully_encoded_celebahq_dataset_alternative.pt", weights_only=False, map_location=device)
    ...
    #x = pcagmm_generator.sample(1)#sample_multiple_pcs(pc_weights={5 : -60,3 : 82, 8:-63, 18:38, 39:-18, 7:-59, 0:80},return_average=False)
    # print(x.shape)
